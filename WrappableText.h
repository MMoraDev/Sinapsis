...
class WrappableText : public UIElement
{
    ...
    public:
         ...
         */
        WrappableText(int x, int y, int height, int width, string text, Vector2f padding, Style style = Style::BODY, Color fontColor = Color::Black, Color bgColor = Color::Transparent, float borderRadius = 0);
